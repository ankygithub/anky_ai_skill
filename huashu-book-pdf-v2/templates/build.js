...
function build() {
  ...
  // 字号切换控件 HTML
  const fontSizeControlHtml = `
<div class="font-size-control" id="fontSizeControl">
  <label>字号</label>
  <button data-size="small" onclick="setFontSize('small')">小</button>
  <button data-size="medium" onclick="setFontSize('medium')">中</button>
  <button data-size="large" onclick="setFontSize('large')">大</button>
</div>`;
...
(function() {
  ...
  const STORAGE_KEY = 'book_font_size';
